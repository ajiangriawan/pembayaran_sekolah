...
// Check if user is logged in and has the 'kepsek' role
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="text-center mt-4 mb-4">
            <h4>Formulir Tambah Kepsek</h4>
          </div>
          <form class="row g-3" method="post" action="proses_tambahkepsek.php">
            <div class="col-12">
              <label for="username" class="form-label">Username</label>
              <input type="text" class="form-control" id="username" name="username" placeholder="Masukan username kepsek" required>
            </div>
            <div class="col-12">
              <label for="nama" class="form-label">Nama kepsek</label>
              <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukan nama kepsek" required>
            </div>
            <div class="col-12">
            ...
            <div class="col-12 text-end">
              <button type="submit" class="btn btn-primary">Tambah kepsek</button>
            </div>
          </form>
        </div>
      </div>
