      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="text-center mt-4 mb-4">
            <h4>Formulir Edit SPP</h4>
          </div>
          <form class="row g-3" method="post" action="proses_editspp.php">
            <input name="id" value="<?php echo $data['id_spp']; ?>" hidden />
            <div class="col-12">
              <label for="tahun" class="form-label">Tahun</label>
              <input type="text" class="form-control" id="tahun" name="tahun" placeholder="Masukan tahun" value="<?php echo $data['tahun']; ?>" required>
            </div>
            <div class="col-12">
              <label for="nominal" class="form-label">Nominal</label>
              <input type="int" class="form-control" id="nominal" name="nominal" placeholder="Masukan nominal" value="<?php echo $data['nominal']; ?>" required>
            </div>
            <div class="col-12 text-end">
              <button type="submit" class="btn btn-primary">Ubah SPP</button>
            </div>
          </form>
        </div>
      </div>
